 ...
 * 2.对于非文本文件(.jpg,.mp3,.mp4,.avi,.dov,.ppt)，使用字节流处理
 * 3.
 */
public class FileInputOuputStreamtest {
    ...
    @Test
    public void tetsFileInputStram(){
...
//        String destpPath = "C:\\Users\\Leo-MESSI\\Pictures\\Camera Roll\\2copy.jpg";
        String srcpPath = "hello.txt";
        String destpPath = "hello3.txt";
        copyFile(srcpPath,destpPath);
