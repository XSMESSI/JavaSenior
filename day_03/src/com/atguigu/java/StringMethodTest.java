...
public class StringMethodTest {
    ...
    public void test4(){
        ...
        boolean matches = str11.matches("\\d+");
        ...
        String str22 = "hello|world|java";
        String[] strs = str22.split("\\|");
        for (int i = 0; i < strs.length; i++) {
            System.out.println(strs[i]);
        }

        System.out.println();
        String str33= "hello.world.java";
        String[] strs2 = str33.split("\\.");
    ...
    public void test1(){
        ...
        System.out.println("s1 = " + s1);//s1是不可变的，仍然是原来字符串
        System.out.println("s2 = " + s2);//改为小写以后的字符串
