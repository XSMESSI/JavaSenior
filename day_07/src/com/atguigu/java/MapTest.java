 ...
 *
 * 二、Map结构的理解
 *  Map中的key：无序的，不重复的，使用Set存储所有的key   ---> key所在的类要重写equals()和hashCode() （以HashMap为例）
 ...
 *              如果key1的哈希值和已经存在的数据的哈希值都不相同，此时key1-value1添加成功
...
public class MapTest {
    ...
    public void test4(){
        ...
        System.out.println("map.get(34) = " + map.get(34));

        //oolean containsKey(Object key)
